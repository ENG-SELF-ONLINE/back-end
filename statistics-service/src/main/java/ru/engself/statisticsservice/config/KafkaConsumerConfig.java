package ru.engself.statisticsservice.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, String> commonConsumerFactory() {
        return new DefaultKafkaConsumerFactory<>(commonConsumerConfig(), new StringDeserializer(), new JsonDeserializer<>(String.class));
    }
