...
public interface UserTestResultService {
    UserTestResultDTO createUserTestResult(UserTestResultDTO userTestResultDTO, UUID lessonId, UUID userId);
    ...
    Integer getBookProgressPercentByUserIdAndType(LessonType type, UUID userId);
}
